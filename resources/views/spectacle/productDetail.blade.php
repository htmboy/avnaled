...
<script type="text/javascript" src="/spectacle/js/pro.js"></script>
<div class="content">
    <div class="pro_details details">
        ...
        <div class="pro_attr">
            ...
            <div class="propar" style="text-align: center; padding-top: 20px;">
                <div class="proparp"> <a href="http://wpa.qq.com/msgrd?v=3&amp;site=澳镭照明&amp;menu=yes&amp;uin=755930694" target="_blank" title="立即咨询"><img style="border: 0" src="/spectacle/img/buynowsmalls.gif" alt="立即咨询"></a> </div>
            </div>
        </div>
    </div>
    <div class="clear"></div>
    ...
    <div class="content">
        <div class="pro_commend">
            ...
            <ul>
                ...
                <li>
                    <a href="/spectacle/product/detail/{{$product->id}}.html">
        ...
        <div class="news_random news_random_ new-s">
            <div class="latest_dl">
                <a href="/spectacle/article/detail/{{$article_recommends->first()->id}}.html" target="_blank">
                    <img src="/spectacle/img/5e9eb43e2e1b9.png" alt="{{$article_recommends->first()->title}}" />
                    <span>
            ...
            <ul>
                ...
                <li class="{{$key%2?'fr':'fl'}}">
                    ...
                    <a target="_blank" href="/spectacle/article/detail/{{$article->id}}.html">{{$article->title}}</a>
                </li>
                @endforeach
            </ul>
            <div class="clear"></div>
