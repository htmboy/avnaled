    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="gallery.blade.php" class="nav-link active">
              ...
              <div class="card-body">
                ...
                <div>
                  <div class="filter-container p-0 row">
                    ...
                    <form action="" name="uploadImage" style="opacity: 0" method="post" enctype="multipart/form-data">
                      {{csrf_field()}}
                    ...
                    <div class="filtr-item col-sm-2" data-category="1" data-sort="white sample">
                      <a href="/backstage/product/gallery/{{$pro_id}}/add">
                        <img src="/backstage/dist/img/uploadImage.jpg" class="img-fluid mb-2" alt="white sample"/>
                      </a>
                    </div>
