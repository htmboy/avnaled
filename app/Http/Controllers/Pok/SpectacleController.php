...
class SpectacleController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('pok.index', compact('carousels', 'title', 'keywords', 'description', 'products', 'articles',
    ...
    public function product(){
        ...
        return view('pok.product', compact('title', 'keywords', 'description', 'products'));
    }
